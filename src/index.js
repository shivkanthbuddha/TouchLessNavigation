...
const IMAGE = 'https://dl1.cbsistatic.com/i/2016/11/14/fdf4f51e-4db4-4b68-adc0-3f6e1259c969/dceb47d3fbde13fa4f2d7b941eb67aa3/imgingest-7677297894185409389.png';
  ...
  render() {
    ...
    return (
      <div className="fish-tank">
        ...
        <img width="50px" style={fishStyle} className={toMirror ? 'mirror' : ''} src={IMAGE} />
      </div>
    );
  }
}
